      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <section className="mt-8 rounded-xl border border-zinc-900 bg-zinc-950/40 p-5">
          ...
          <ul className="flex flex-wrap gap-1.5 text-sm">
            {[
              { slug: "synthetic-talent", label: "Synthetic talent" },
              { slug: "k-aesthetic", label: "K-aesthetic" },
              { slug: "styling-dna", label: "Styling DNA" },
              { slug: "brand-kit", label: "Brand kit" },
              { slug: "category-exclusivity", label: "Category exclusivity" },
              { slug: "disclosure-metadata", label: "Disclosure metadata" },
            ].map((entry) => (
              <li key={entry.slug}>
                <Link
                  href={`/en/glossary#${entry.slug}`}
